...
@Role(name = ReadPublisherRole.NAME, securityScope = "REST")
public class ReadPublisherRole extends AnnotatedRoleDefinition {
    public final static String NAME = "ReadPublisher";
