...
public class UpdateLibrarians {
    ...
    public ResponseWrapper UpdateLibrarian(@RequestBody Librarians lib, @PathVariable String id){
        ...
        try{
            ...
            Subject ps = dataManager.load(Subject.class)
                    ...
                    .one();
            ps.setSubjectName(lib.getPhoneNumber());
            ps.setDescription(lib.getNationalId());
            ps.setCode(lib.getEmail());
